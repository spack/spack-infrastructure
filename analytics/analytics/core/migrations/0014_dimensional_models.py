# Generated by Django 4.2.4 on 2024-05-15 02:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("compiler_name", models.CharField(blank=True, max_length=32)),
                ("compiler_version", models.CharField(blank=True, max_length=32)),
                ("arch", models.CharField(blank=True, max_length=64)),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.CheckConstraint(
                check=models.Q(("name", ""), _negated=True), name="no-empty-name"
            ),
        ),
