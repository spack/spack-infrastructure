...
### API Docs
Once the application is running, you can access the swagger interface at http://localhost:8000/api/v1/docs
...
3. Run in a separate terminal:
   1. `source ./dev/export-env.sh`
   2. `celery --app analytics.celery worker --loglevel INFO --without-heartbeat`
...
* When running the "Develop Natively" configuration, override the environment variables:
  ...
  * `CELERY_BROKER_URL`, using the port from
