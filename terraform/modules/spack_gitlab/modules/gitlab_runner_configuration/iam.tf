locals {
  ...
  mirror_roles = {
    ...
    "protected_binary_mirror" = {
      ...
      "conditions" = [
        "project_path:${data.gitlab_project.this.path}:ref_type:branch:ref:develop",
        "project_path:${data.gitlab_project.this.path}:ref_type:branch:ref:releases/v*",
        "project_path:${data.gitlab_project.this.path}:ref_type:tag:ref:develop-*",
        "project_path:${data.gitlab_project.this.path}:ref_type:tag:ref:v*"
      ],
    }
  }
}
